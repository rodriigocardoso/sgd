...
<?php } ?>
 ...
 <div>
<tr><a href="dompdf/diretoria_pdf.php" type="button" class="btn btn-danger btn-sm" > 
             <i class="fa fa-file-pdf-o">EXPORTAR PDF </i></a> </tr>
             
<tr><a href="diretoria_excel.php" type="button" class="btn btn-btn btn-success btn-sm" > 
