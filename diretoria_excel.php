...
$diretoria =  $_SESSION['sigla_diretoria'];
	...
	INNER JOIN area on demanda.cod_area_fk = area.cod_area INNER JOIN diretoria on area.cod_diretoria_fk = diretoria.cod_diretoria WHERE diretoria.sigla_diretoria = '$diretoria'") ;
