<?php
    //declaramos uma variavel para monstarmos a tabela
	 ...
	 $dadosXls .= "<th>Fase</th>";
	 $dadosXls .= "<th>Valor Realizado</th>";
	 $dadosXls .= "<th>Valor Necessário</th>";
	 $dadosXls .= "<th>Quantidade de Parcelas</th>";
	 $dadosXls .= "      </tr>";
	...
	$dadosXls .= " <td>".$res['vlr_realizado']."</td>";
	$dadosXls .= " <td>".$res['vlr_necessario']."</td>";
	$dadosXls .= " <td>".$res['parcelas']."</td>";
