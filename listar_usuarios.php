...
<td><a class="nav-link" href=editar_usuario.php?cod_usuario=<?php echo $unid['cod_usuario'] ?> onclick="return confirm(\'Confirma Exclusão do Registro?\')"><i class="fa fa-edit"></i> Editar</a></td>

<td><a href="status_usuario.php?cod_usuario=<?php echo $unid['cod_usuario'] ?>" type="button" class="btn btn-danger btn-sm" > 
             <i class="fa fa-user-times">Desabilitar / Habilitar </i></a> </td>
...
<?php } ?>
 ...
 <div>
<tr><a href="dompdf/usuarios_pdf.php" type="button" class="btn btn-danger btn-sm" > 
             <i class="fa fa-file-pdf-o">EXPORTAR PDF </i></a> </tr>
             
<tr><a href="usuarios_excel.php" type="button" class="btn btn-btn btn-success btn-sm" > 
