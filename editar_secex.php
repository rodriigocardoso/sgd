...
<form action="confirm_edit_secex.php" method="POST" autocomplete="off" enctype="multipart/form-data" class="form-horizontal">
...
<a href="listar_demandas_secex.php" onclick='return cancelar();' type="button" class="btn btn-danger btn-sm" > 
