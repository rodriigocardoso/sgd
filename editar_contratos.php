...
FROM demanda INNER JOIN contrato on demanda.cod_demanda = contrato.cod_demanda_fk INNER JOIN area on demanda.cod_area_fk = area.cod_area INNER JOIN diretoria on area.cod_diretoria_fk = diretoria.cod_diretoria INNER JOIN aquisicao on demanda.cod_demanda = aquisicao.cod_demanda_fk WHERE demanda.cod_demanda = '$cod_demanda'")->fetch_assoc();
...
<form action="confirm_edit_contratos.php" method="POST" autocomplete="off" enctype="multipart/form-data" class="form-horizontal">
...
<div class="row form-group">
<div class="col col-md-3"><label for="num_processo" class=" form-control-label">Numero do Processo:</label></div>
...
<div class="col-12 col-md-9"><input type="text" id="contratada" name="contratada" value="<?php echo $qr_demanda['contratada'] ?>" class="form-control" ><small class="help-block form-text"></small></div>
</div>


<div class="row form-group">
<div class="col col-md-3"><label for="num_contrato" class=" form-control-label">Número do Contrato:</label></div>
<div class="col-12 col-md-9"><input type="text" id="num_contrato" name="num_contrato" value="<?php echo $qr_demanda['num_contrato'] ?>" class="form-control" ><small class="help-block form-text"></small></div>
</div>
...
<div class="row form-group">
<div class="col col-md-3"><label for="text-input"class=" form-control-label">Vencimento:</label></div>
<div class="col-12 col-md-9"><input type="date" id="vencimento" name="vencimento" value="<?php echo $qr_demanda['vencimento'] ?>" class="form-control" ><small class="help-block form-text"></small></div>
</div>
															
<div class="row form-group">
<div class="col col-md-3"><label for="text-input" class=" form-control-label">Data de Assinatura:</label></div>
<div class="col-12 col-md-9"><input type="date" id="dt_assinatura" name="dt_assinatura" value="<?php echo $qr_demanda['dt_assinatura'] ?>" class="form-control"><small class="help-block form-text"></small></div>
</div>
...
<a href="listar_demandas_contratos.php" onclick='return cancelar();' type="button" class="btn btn-danger btn-sm" > 
