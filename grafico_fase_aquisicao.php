...
<body>
   ...
   <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <a class="navbar-brand" href="index_Aquisicao.php"><img src="images/logo_principal.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="index_Aquisicao.php"><img src="images/logo2.png" alt="Logo"></a>
            </div>

            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="index_Aquisicao.php"> <i class="menu-icon fa fa-dashboard"></i>Principal </a>
                    </li>
					...
					<li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="listar_projetos_aquisicao.php">Listar Projetos</a></li>
                        </ul>
                    </li>
                          <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="listar_demandas_aquisicao.php">Listar Demandas de Aquisições</a></li>
                            <li><i class="fa fa-table"></i><a href="listar_demandas_geral_aquisicao.php">Listar Demandas Geral</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="relatorio_financeiro_aquisicao.php">Relatório Financeiro</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="relatorio_fase_aquisicao.php">Relatório Fase</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="relatorio_tipo_aquisicao.php">Relatório Tipo</a></li>
                        </ul>
                    </li>
					 ...
					 <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-spinner"></i><a href="grafico_fase_aquisicao.php">Fases das Demandas</a></li>
                            <li><i class="menu-icon fa fa-file-word-o"></i><a href="grafico_tipo_aquisicao.php">Tipo de Demandas</a></li>
							<li><i class="menu-icon fa fa-puzzle-piece"></i><a href="grafico_status_aquisicao.php">Demandas Iniciadas</a></li>
                        </ul>
                    </li>
...
["Fase", "Quantidade", { role: "style" } ],
["AUTORIZAÇÃO DIREX",<?php echo $count ?>, "red"],
["AUTORIZAÇÃO CONSAD",<?php echo $count2 ?>, "red"],
["PESQUISA DE MERCADO",<?php echo $count3 ?>, "red"],
["PARECER TÉCNICO",<?php echo $count4 ?>, "red"],
["DISPONIBILIDADE ORÇAMENTÁRIA",<?php echo $count5 ?>, "red"],
["ELABORAÇÃO DE EDITAL",<?php echo $count6 ?>, "red"],
["ELABORAÇÃO DE MINUTA DE CONTRATO",<?php echo $count7 ?>, "red"],
["VISTO JURIDICO",<?php echo $count8 ?>, "red"],
["PUBLICAÇÃO DA LICITAÇÃO",<?php echo $count9 ?>, "red"],
["PREGÃO",<?php echo $count10 ?>, "red"],
["ANÁLISE DA PROPOSTA",<?php echo $count11 ?>, "red"],
["RECURSO",<?php echo $count12 ?>, "red"],
["ADJUDICAÇÃO / HOMOLOGAÇÃO / PUBLICAÇÃO",<?php echo $count13 ?>, "red"],
["RECEBIMENTO DA PROPOSTA ORIGINAL",<?php echo $count14 ?>, "red"],
["EMPENHO",<?php echo $count15 ?>, "red"],
["ELABORAÇÃO DE CONTRATO",<?php echo $count16 ?>, "red"],
["VISTOS DO JURÍDICO",<?php echo $count17 ?>, "red"],
["ASSINATURA CONTRATADA",<?php echo $count18 ?>, "red"],
["DECRETO 7689",<?php echo $count19 ?>, "red"],
["ASSINATURA EBC",<?php echo $count20 ?>, "red"],
["CONTRATADO",<?php echo $count21 ?>, "red"],
["GESTÂO",<?php echo $count22 ?>, "red"],
["CORREÇÕES DO DEMANDAMENTE",<?php echo $count23 ?>, "red"],
["AUTORIZAÇÃO DA FASE EXTERNA",<?php echo $count24 ?>, "red"],
["ORDENADOR DE DESPESAS",<?php echo $count25 ?>, "red"],
["INSTRUÇÃO DO PROCESSO",<?php echo $count26 ?>, "red"],
["FINANCEIRO",<?php echo $count27 ?>, "red"],
["PAGO",<?php echo $count28 ?>, "red"],
["PREGÃO SUSPENSO",<?php echo $count29 ?>, "red"],
["PAGAMENTO",<?php echo $count30 ?>, "red"],
["REVISÃO DE TR/PB",<?php echo $count31 ?>, "red"],
["ANÁLISE GT",<?php echo $count32 ?>, "red"],
["ANÁLISE CANCELADA POR ORDEM SUPERIOR",<?php echo $count33 ?>, "red"]
