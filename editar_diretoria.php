...
demanda.regional, 
demanda.situacao, 
demanda.valor_solicitado, 
demanda.valor_aprovado, 
demanda.fase_demanda 
FROM demanda LEFT JOIN projeto on demanda.cod_projeto_fk = projeto.cod_projeto LEFT JOIN area on demanda.cod_area_fk = area.cod_area LEFT JOIN diretoria on area.cod_diretoria_fk = diretoria.cod_diretoria  WHERE demanda.cod_demanda = '$cod_demanda'")->fetch_assoc();
...
<form action="confirm_edit_diretoria.php" method="POST" autocomplete="off" enctype="multipart/form-data" class="form-horizontal">
...
<div class="col-12 col-md-9"><input type="text" id="sigla_diretoria" name="sigla_diretoria" value="<?php echo $qr_demanda['sigla_diretoria'] ?>" class="form-control" required/><small class="help-block form-text"></small></div>
</div>
...
<div class="col-12 col-md-9"><input type="text" id="nome_area" name="nome_area" value="<?php echo $qr_demanda['nome_area'] ?>" class="form-control" required/><small class="help-block form-text"></small></div>
</div>


<div class="row form-group">
<div class="col col-md-3"><label for="area" class=" form-control-label">Projeto:</label></div>
<div class="col-12 col-md-9"><input type="text" id="nome" name="nome" value="<?php echo $qr_demanda['nome'] ?>" class="form-control" required/><small class="help-block form-text"></small></div>
</div>
...
<div class="col-12 col-md-9"><textarea type="text" name="objeto" id="objeto" rows="9"class="form-control"> <?php echo $qr_demanda['objeto'] ?> </textarea> </div>
</div>
...
<option value="<?php echo $qr_demanda['finalidade'] ?>"><?php echo $qr_demanda['finalidade'] ?></option>
...
<div class="row form-group">
<div class="col col-md-3"><label for="regional" class=" form-control-label">Regional:</label></div>
<div class="col-12 col-md-9">
<select name="regional" id="regional" class="form-control-l form-control" required/>
<option value="<?php echo $qr_demanda['regional'] ?>"><?php echo $qr_demanda['regional'] ?></option>
...
<select name="situacao" id="situacao" class="form-control-l form-control">
 <option value="<?php echo $qr_demanda['situacao'] ?>" required/> <?php echo $qr_demanda['situacao'] ?></option>
<option>Nova</option>
...
<div class="col-12 col-md-9"><input type="moeda" id="valor_solicitado" name="valor_solicitado" value="<?php echo $qr_demanda['valor_solicitado'] ?>" class="form-control" required/><small class="help-block form-text"></small></div>
</div>
															
<div class="row form-group">
<div class="col col-md-3"><label for="text-input" class=" form-control-label">Valor Aprovado:</label></div>
<div class="col-12 col-md-9"><input type="moeda" id="valor_aprovado" name="valor_aprovado" value="<?php echo $qr_demanda['valor_solicitado'] ?>" class="form-control" required/><small class="help-block form-text"></small></div>
</div>
...
<a href="listar_demandas_diretoria.php" onclick='return cancelar();' type="button" class="btn btn-danger btn-sm" > 
