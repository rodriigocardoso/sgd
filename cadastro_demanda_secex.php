...
<div class="col-12 col-md-9">
<input type="text" id="valor_solicitado" name="valor_solicitado" data-symbol="R$" placeholder="Informe o valor solicitado para a demanda" class="form-control"><small class="help-block form-text"></small></div>
</div>
															
<div class="row form-group">
<div class="col col-md-3"><label for="text-input" class=" form-control-label">Valor Aprovado:</label></div>
<div class="col-12 col-md-9"><input type="moeda" id="valor_aprovado" name="valor_aprovado" placeholder="Informe o valor aprovado para a demanda" class="form-control"><small class="help-block form-text"></small></div>
 </div>
