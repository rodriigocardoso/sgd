                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Lista de Demandas Financeiro</strong>
                            </div>
                            <div class="card-body">
...
<?php } ?>
 ...
 <div>
<tr><a href="dompdf/financeiro_pdf.php" type="button" class="btn btn-danger btn-sm" > 
             <i class="fa fa-file-pdf-o">EXPORTAR PDF </i></a> </tr>
             
<tr><a href="financeiro_excel.php" type="button" class="btn btn-btn btn-success btn-sm" > 
