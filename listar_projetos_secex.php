...
<td ><a href="editar_projeto_secex.php?cod_projeto=<?php echo $linhas['cod_projeto'] ?>">Editar</a></td>
<td><a href="deleta_projeto.php?cod_projeto=<?php echo $linhas['cod_projeto'] ?>">Deletar</a></td><?php } ?>
	</tr>
	</tbody>
                                </table>
                            </div>
