...
<td><input type="file" name="arquivo" align="center" position="absolute" size="35" maxlength="256" size="35" maxlength="256"></td><br><br>

</div>				
<td><input type="submit" value="Enviar" name="enviar" style=" border-radius: 25px; text-align: center"></td>
