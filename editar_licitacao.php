...
aquisicao.tipo, 
licitacao.num_pregao, 
licitacao.dt_abertura, 
licitacao.fase_licitacao, 
demanda.fase_demanda 
FROM demanda LEFT JOIN  area on demanda.cod_area_fk = area.cod_area LEFT JOIN diretoria on area.cod_diretoria_fk = diretoria.cod_diretoria LEFT JOIN aquisicao on demanda.cod_demanda = aquisicao.cod_demanda_fk LEFT JOIN licitacao on aquisicao.cod_aquisicao = licitacao.cod_aquisicao_fk  WHERE demanda.cod_demanda = '$cod_demanda'")->fetch_assoc();
...
<form action="confirm_edit_licitacao.php" method="POST" autocomplete="off" enctype="multipart/form-data" class="form-horizontal">
...
<div class="row form-group">
<div class="col col-md-3"><label for="num_processo" class=" form-control-label">Número do Pregão:</label></div>
<div class="col-12 col-md-9"><input type="text" id="num_pregao" name="num_pregao" value="<?php echo $qr_demanda['num_pregao'] ?>" class="form-control" required/><small class="help-block form-text"></small></div>
</div>


<div class="row form-group">
<div class="col col-md-3"><label for="dt_abertura" class=" form-control-label">Abertura do Pregão:</label></div>
<div class="col-12 col-md-9"><input type="date" id="dt_abertura" name="dt_abertura" value="<?php echo $qr_demanda['dt_abertura'] ?>" class="form-control" required/><small class="help-block form-text"></small></div>
</div>


<div class="row form-group">
<div class="col col-md-3"><label for="fase_licitacao" class=" form-control-label">Fase da Licitação:</label></div>
<div class="col-12 col-md-9"><input type="text" id="fase_licitacao" name="fase_licitacao" value="<?php echo $qr_demanda['fase_licitacao'] ?>" class="form-control" required/><small class="help-block form-text"></small></div>
</div>
...
<a href="listar_demandas_licitacao.php" onclick='return cancelar();' type="button" class="btn btn-danger btn-sm" > 
