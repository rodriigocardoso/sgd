...
?>
 ...
 <a class="nav-link" href="#"><i class="fa fa-user"></i><?php echo  $_SESSION['sigla_diretoria']; ?></a>
        ...
        <div class="breadcrumbs">
			...
			<center>
                <form action="pesquisa_diretoria.php" method="POST" autocomplete="off" >
<div>
...
elseif ($count == 0){
echo "<center>Registro não encontrado! Deseja cadastrar uma Nova Demanda? "."<a href=cadastro_demanda_diretoria.php> Sim </a>"."</center>";
}
else { ?>
									<table class="table table-bordered">
                                    <thead>
                                        <tr>
												<th scope="col">Cod_Demanda</th>
...
<td><a class="nav-link" href=editar_diretoria.php?cod_demanda=<?php echo $linhas['cod_demanda'] ?>"><i class="fa fa-edit"></i> Editar</a></td>
<td><a class="nav-link" href=completo_diretoria.php?cod_demanda=<?php echo $linhas['cod_demanda'] ?>"><i class="fa fa-clone"></i> Completo</a></td>
