...
?>
 ...
 <a class="nav-link" href="#"><i class="fa fa-user"></i><?php echo  $_SESSION['sigla_diretoria']; ?></a>
        ...
        <div class="breadcrumbs">
			...
			<center>
                <form action="pesquisa_licitacao.php" method="POST" autocomplete="off" >
<div>
...
$qr_demanda = $db->query("SELECT * FROM demanda INNER JOIN aquisicao on demanda.cod_demanda = aquisicao.cod_demanda_fk INNER JOIN projeto on demanda.cod_projeto_fk = projeto.cod_projeto INNER JOIN area on demanda.cod_area_fk = area.cod_area INNER JOIN diretoria on area.cod_diretoria_fk = diretoria.cod_diretoria INNER JOIN licitacao on aquisicao.cod_aquisicao = licitacao.cod_aquisicao_fk WHERE demanda.objeto LIKE '%$pesquisar%'");
...
elseif ($count == 0){
echo "<center>Registro não encontrado! <br> Para cadastrar uma Nova Demanda entre em contato com área responsável."."</center>";
}
else { ?>
                                    ...
                                    <thead>
                                        <tr>
												...
												<th scope="col" >Número do Pregão</th>
												<th scope="col">Abertura do Pregão</th>
												<th scope="col" >Fase da Licitação</th>
