...
$perfil = $db->query("SELECT * FROM perfil");
...
<div class="content mt-3">
            <div class="animated fadeIn">
				...
				<form action="insere_usuario.php" method="POST" class="">
				<div class="form-group"><label for="matricula" class=" form-control-label">Matrícula:</label><input type="text" id="matricula" name="matricula" placeholder="Digite a Matrícula.." class="form-control" autocomplete="off"></div>
															
															<div class="form-group"><label for="nome" class=" form-control-label">Nome:</label><input type="text" id="nome" name="nome" placeholder="Digite o Nome Completo.." class="form-control" autocomplete="off"></div>
															  
															   
                <div class="col col-md-3"><label for="selectLg" class=" form-control-label">Diretoria:</label></div>
                                                                    
                                 <select name="diretoria" id="diretoria" class="form-control-l form-control">
                  ...
                  <div class="col col-md-3"><label for="selectLg" class=" form-control-label">Área:</label></div>
                    ...
                    <select name="area" id="area" class="form-control-l form-control">
                    <option value="">Escolha o área</option>
					<option><?php while($area1 = $area->fetch_array()) { ?></option>
					<option value="<?php echo $area1['nome_area']; ?>"><?php echo $area1['nome_area']; ?> </option>
						<?php } ?></option>													
															...
															<div class="form-group"><label for="nf-login" class=" form-control-label">Login:</label><input type="text" id="login" name="login" placeholder="Digite o Login.." class="form-control" autocomplete="off"></div>
															
															<div class="form-group"><label for="nf-password" class=" form-control-label">Senha:</label><input type="password" id="senha" name="senha" placeholder="Digite a Senha.." class="form-control"></div>
                                                            
															<div class="form-group"><label for="nf-email" class=" form-control-label">E-mail:</label><input type="email" id="email" name="email" placeholder="Digite o E-mail.." class="form-control" autocomplete="off"></div>
															   
															   
            <div class="col col-md-3"><label for="selectLg" class=" form-control-label">Status:</label></div>
                                                                    
                                <select name="status" id="status" class="form-control-l form-control">
					...
					<div class="col col-md-3"><label for="selectLg" class=" form-control-label">Perfil:</label></div>
                    
                    <select name="perfil" id="perfil" class="form-control-l form-control">
                    <option value="">Escolha o perfil</option>
					<option><?php while($perf = $perfil->fetch_array()) { ?></option>
					<option value="<?php echo $perf['nome_perfil']; ?>"><?php echo $perf['nome_perfil']; ?> </option>
						<?php } ?></option>													
                ...
                <div class="card-footer">
                 <button align= "center" type="submit" class="btn btn-primary btn-sm">
