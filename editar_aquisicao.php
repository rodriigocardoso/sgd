...
aquisicao.iniciado, 
aquisicao.dt_recebimento,
aquisicao.tipo,
demanda.fase_demanda 
FROM demanda INNER JOIN area on demanda.cod_area_fk = area.cod_area INNER JOIN diretoria on area.cod_diretoria_fk = diretoria.cod_diretoria INNER JOIN aquisicao on demanda.cod_demanda = aquisicao.cod_demanda_fk WHERE demanda.cod_demanda = '$cod_demanda'")->fetch_assoc();
...
<form action="confirm_edit_aquisicao.php" method="POST" autocomplete="off" enctype="multipart/form-data" class="form-horizontal">
...
<div class="col-12 col-md-9"><input type="text" id="num_processo" name="num_processo" value="<?php echo $qr_demanda['num_processo'] ?>" class="form-control" ><small class="help-block form-text"></small></div>
</div>
                                                                
<div class="row form-group">
<div class="col col-md-3"><label for="iniciado" class=" form-control-label">Iniciado:</label></div>
<div class="col-12 col-md-9">
<select name="iniciado" id="iniciado" class="form-control-l form-control" required/>
<option value="<?php echo $qr_demanda['iniciado'] ?>"><?php echo $qr_demanda['iniciado'] ?></option>
<option>Sim</option>
<option>Não</option>
</select>
</div>
...
<div class="row form-group">
<div class="col col-md-3"><label for="dt_recebimento" class=" form-control-label">Data de Recebimento:</label></div>
<div class="col-12 col-md-9"><input type="date" id="dt_recebimento" name="dt_recebimento" value="<?php echo $qr_demanda['dt_recebimento'] ?>" class="form-control" required/><small class="help-block form-text"></small></div>
</div>
...
<a href="listar_demandas_aquisicao.php" onclick='return cancelar();' type="button" class="btn btn-danger btn-sm" > 
