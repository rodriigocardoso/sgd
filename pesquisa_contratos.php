...
?>
 ...
 <a class="nav-link" href="#"><i class="fa fa-user"></i><?php echo  $_SESSION['sigla_diretoria']; ?></a>
        ...
        <div class="breadcrumbs">
			...
			<center>
                <form action="pesquisa_contratos.php" method="POST" autocomplete="off" >
<div>
...
$qr_demanda = $db->query("SELECT * FROM demanda INNER JOIN aquisicao on demanda.cod_demanda = aquisicao.cod_demanda_fk INNER JOIN projeto on demanda.cod_projeto_fk = projeto.cod_projeto INNER JOIN area on demanda.cod_area_fk = area.cod_area INNER JOIN diretoria on area.cod_diretoria_fk = diretoria.cod_diretoria INNER JOIN contrato on demanda.cod_demanda=contrato.cod_demanda_fk WHERE demanda.objeto LIKE '%$pesquisar%'");
