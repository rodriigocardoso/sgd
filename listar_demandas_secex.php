...
$qr_demanda = $db->query("SELECT * FROM demanda INNER JOIN aquisicao on demanda.cod_demanda = aquisicao.cod_demanda_fk INNER JOIN projeto on demanda.cod_projeto_fk = projeto.cod_projeto INNER JOIN area on demanda.cod_area_fk = area.cod_area INNER JOIN diretoria on area.cod_diretoria_fk = diretoria.cod_diretoria INNER JOIN financeiro on demanda.cod_financeiro_fk = financeiro.cod_financeiro") ;
?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Lista de Demandas Secex</strong>
                            </div>
                            <div class="card-body">
...
<td><a class="nav-link" href=editar_secex.php?cod_demanda=<?php echo $linhas['cod_demanda'] ?>"><i class="fa fa-edit"></i> Editar</a></td>
<td><a class="nav-link" href=deletar_demanda.php?cod_demanda=<?php echo $linhas['cod_demanda'] ?>"><i class="fa fa-trash"></i> Excluir</a></td>
<td><a class="nav-link" href=completo_secex.php?cod_demanda=<?php echo $linhas['cod_demanda'] ?>"><i class="fa fa-clone"></i> Completo</a></td>
...
<?php } ?>
 ...
 <div>
<tr><a href="dompdf/secex_pdf.php" type="button" class="btn btn-danger btn-sm" > 
             <i class="fa fa-file-pdf-o">EXPORTAR PDF </i></a> </tr>
             
<tr><a href="secex_excel.php" type="button" class="btn btn-btn btn-success btn-sm" > 
