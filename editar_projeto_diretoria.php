...
$qr_projeto = $db->query("SELECT cod_projeto, nome, ano FROM projeto WHERE cod_projeto = '$cod_projeto'")->fetch_assoc();
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form action="confirm_edit_projeto_diretoria.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
...
<div class="col-12 col-md-9"><input type="hidden" class="form-control" value="<?php echo $qr_projeto['cod_projeto'] ?>" id="cod_projeto" name="cod_projeto" style="padding:8px; width: 100%; " readonly ><small class="help-block form-text"></small>
                            </div>   </div>                             
...
<div class="col-12 col-md-9"><input type="text" id="nome" name="nome" placeholder="Informe o Nome do Projeto" class="form-control" value="<?php echo $qr_projeto['nome']; ?>"><small class="help-block form-text"></small></div>
</div>
